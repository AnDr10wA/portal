"""
Django settings for homemining project.
...
SECRET_KEY = 'django-insecure-to6i^#19hm-=btvsoy@g%av+_z#6gqeqxvynm_@r3(7ej!mchr'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates', 'news/templates', 'cotalog/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
